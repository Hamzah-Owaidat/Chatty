            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                <div>
                  ...
                  <Input id="uname" name="username" type="text" value={formData.username}
                    placeholder="Enter your username" onChange={handleChange} className={!errors.username ? `border-l-3
